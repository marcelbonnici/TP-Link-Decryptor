...
![Clamping Onto The Flash Chip](README-gifs/2c.gif)
...
![Flashing and Binwalking](README-gifs/2d.gif)
...
![Observing Partitions in the Boot Logs](README-gifs/3b.gif)
...
![Diving into the Router's Web Portal](README-gifs/3c.gif)
